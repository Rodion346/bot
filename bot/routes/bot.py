...
async def process_start_command(message: types.Message):
    ...
    requests.post("https://rodion346-api-ai-bot-1eac.twc1.net/api/v1/user", json=payload)
...
async def profile_info(message: types.Message):
    r = requests.get(f"https://rodion346-api-ai-bot-1eac.twc1.net/api/v1/user/{message.from_user.id}")
    re = r.json()
    id_user = re.get("id")
